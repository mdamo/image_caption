...
class Config(object):
    ...
    def __init__(self):
        ...
        self.save_dir = '/home/mauro.emc/image_captioning/models'
	...
	# about the data
	self.dest_path = '/mnt/lustrefs/mauro.emc/data/coco' 
	self.python_dir = '../miniconda2/bin/python'

	# about the training
        #self.train_image_dir = './train/images/train2014'
        self.train_image_dir = '/mnt/lustrefs/sinrag/data/coco/images/train2014'
	self.train_caption_file = './train/captions_train2014.json'
        ...
        # about the testing
        self.test_image_dir = '/mnt/lustrefs/sinrag/data/coco/images/test2015'
